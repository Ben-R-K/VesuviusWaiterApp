...
class OrdersOverviewVm {
  static final ValueNotifier<List<OrderModel>> recordsNotifier =
      ValueNotifier<List<OrderModel>>([
        OrderModel(
          ...
          reservation: ReservationModel(
            ...
            tables: [TableModel(id: 1), TableModel(id: 2)],
          ),
        ...
        OrderModel(
          ...
          reservation: ReservationModel(
            ...
            tables: [TableModel(id: 4), TableModel(id: 5)],
          ),
